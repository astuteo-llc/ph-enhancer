 ...
 * @returns {void}
 */
export const trackThemePreference = () => {
  try {
 ...
 * @returns {void}
 */
export const removeThemeChangeListener = () => {
  try {
    const mediaQuery = window.matchMedia('(prefers-color-scheme: dark)');
 ...
 */
export const trackOrganization = async (authKey = false) => {
 ...
 */
export const initTracking = (options = {}) => {
